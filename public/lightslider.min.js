    ...
    return (
      ...
      (d = {
            ...
            ((z.createPager = function() {
              ...
              k.find(".lSPager").html(f),
                e.gallery === !0 &&
                  ...
                  e.vertical === !0 &&
                    p.parent().css("padding-right", e.vThumbWidth + e.galleryMargin + "px"),
          ...
          if (q * e.slideMove < l) {
            ...
            b === !0 && ((d = a.length), (f = d - 1), c + 1 >= d && (c = f)),
              e.loop === !0 &&
                ...
                b === !0 &&
                  ((d = a.length), (f = d - 1), c + 1 === d ? (c = f) : c + 1 > d && (c = 0))),
            ...
            var d = function(a) {
              ...
              if ((b || (a && (c = 1)), e.autoWidth)) {
                for (
                  var d = 0, f = 0;
                  f < h.length &&
                  ((d += parseInt(h.eq(f).width()) + e.slideMargin), (q = f + c), !(d >= t));
                  f++
                ){;}}
              } else {
        ...
        build: function() {
          ...
          b.initialStyle(),
            this.doCss() &&
              (e.enableTouch === !0 && b.enableTouch(), e.enableDrag === !0 && b.enableDrag()),
