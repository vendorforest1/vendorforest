...
class VenueBillingMethod extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="venue-billingmethod">
        <Card
...
const VenueBillingMethodForm = Form.create({ name: "venue_setting_billingmethod" })(
  VenueBillingMethod,
);

export default VenueBillingMethodForm;
