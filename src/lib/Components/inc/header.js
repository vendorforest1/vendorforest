          ...
          <div className="container">
            <div className="row">
              <div className="col-8 d-flex justify-content-start">
                <small className="mr-4"><i className="icon"><img src="https://img.icons8.com/ios-glyphs/15/000000/marker.png" /></i>Lynn,Massachusetts,US </small>
                <small><i className="icon"><img src="https://img.icons8.com/ios-glyphs/15/000000/new-post.png" /></i>Info@Vendorforest.Com</small>
              </div>
            ...
            <div className="row">
              <div className="col-12 d-flex">
                ...
                <div className="menu-content d-none d-xl-flex justify-content-end align-items-center">
                  <a href="#how_it_works" className="mr-4">HOW IT WORKS</a>
                  <a href="/login" className="mr-4">POST A JOB</a>
                  <a role="button" href="/register" className="button-primary">
                    <i className="icon"><img src="https://img.icons8.com/ios-glyphs/15/ffffff/bookmark-ribbon.png" /></i>JOIN AS A VENDOR
                  </a>
                </div>
              ...
              </div>
              {
                ...
                <div className="col-12 d-flex justify-content-center d-xl-none d-block">
                  ...
                  <div className="menu-hamburger-content w-100">
                    ...
                    <p className=" text-center"><a href="#how-it-works">HOW IT WORKS</a></p>
                    <p className=" text-center"><a href="" >POST A JOB</a></p>
