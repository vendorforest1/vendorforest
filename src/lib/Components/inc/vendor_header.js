            ...
            <div className="row">
              <div className="col-12 d-flex">
                ...
                <div className="menu-content d-none d-xl-flex justify-content-end align-items-center">
                  <a href="/vendor" className="mr-4">DASHBOARD</a>
                  <a href="/vendor/findjob" className="mr-4">JOBS</a>
                  {/* <a href="" className="mr-4">VENDORS</a> */}
                  <a href="/messages/v" className="mr-4">MESSAGES</a>
                ...
                <div className="col-12 d-flex justify-content-center d-xl-none d-block">
                  <div className="w-100">
                    <div className="menu-hamburger-content w-100">
                      <p className=" text-center"><a href="/vendor">DASHBOARD</a></p>
                      <p className=" text-center"><a href="/vendor/findjob">JOBS</a></p>
