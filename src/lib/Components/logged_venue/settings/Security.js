...
class VenueSecurity extends React.Component {
  constructor(props) {
    super(props);
...
const VenueSecurityForm = Form.create({ name: "venue_setting_security" })(VenueSecurity);

export default VenueSecurityForm;
